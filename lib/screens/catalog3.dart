...
List<int> numberList3 = [0, 0, 0, 0, 0];

class MyCatalog3 extends StatelessWidget {
  const MyCatalog3({Key? key}) : super(key: key);
...
class _MyAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      ...
      title: Text('大眾美食', style: TextStyle(color: Colors.black)),
      floating: true,
    );
  }
}
...
class _MyListItemState extends State<_MyListItem> {
  void _increment(Item item){
    setState((){
      numberList3[item.id - 16] += 1;
      print(numberList3[item.id - 16]);
    });
  }
  ...
  Widget build(BuildContext context) {
    var item = context.select<CatalogModel, Item>(
      ...
      // about any other change.
          (catalog) => catalog.getByPosition(widget.index + 16),
    );
                    ...
                    Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Flexible(
                              child: Text(numberList3[item.id - 16].toString()),
                            ),
                            Flexible(
                              child: IconButton(
                                icon: Icon(Icons.add),
