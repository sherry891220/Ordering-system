...
List<int> numberList2 = [0, 0, 0, 0, 0];

class MyCatalog2 extends StatelessWidget {
  const MyCatalog2({Key? key}) : super(key: key);
...
class _MyAppBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
      ...
      title: Text('高纖維美食', style: TextStyle(color: Colors.black)),
      floating: true,
    );
  }
}
...
class _MyListItemState extends State<_MyListItem> {
  void _increment(Item item){
    setState((){
      numberList2[item.id - 11] += 1;
      print(numberList2[item.id - 11]);
    });
  }
  ...
  Widget build(BuildContext context) {
    var item = context.select<CatalogModel, Item>(
      ...
      // about any other change.
          (catalog) => catalog.getByPosition(widget.index + 11),
    );
                    ...
                    Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Flexible(
                              child: Text(numberList2[item.id - 11].toString()),
                            ),
                            Flexible(
                              child: IconButton(
                                icon: Icon(Icons.add),
